...
export const JoinPrivateButton: React.FC  = ()=>{
    return(
        <button className="group relative flex items-center justify-between p-6 bg-surface-container-high hover:bg-surface-container-highest transition-all duration-200 active:scale-[0.98] border-l-0 hover:border-l-[6px] border-primary-container shadow-xl overflow-hidden">
